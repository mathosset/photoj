...
Un bon portrait LinkedIn n'est pas une photo corporate froide. C'est une image qui transmet à la fois **sérieux et accessibilité** — le regard doit inspirer confiance, l'arrière-plan ne doit pas parasiter, la lumière doit être flatteuse sans être artificielle.

Concrètement, voici ce qui compte :

- **Le cadrage** : buste ou portrait serré, le visage doit occuper au moins 60 % de la surface
- **La lumière** : naturelle ou studio — l'essentiel est qu'elle soit douce et directionnelle
- **L'expression** : ni trop figée, ni trop décontractée — un regard direct, une légère détente du visage
- **Le fond** : uni, flou ou légèrement contextualisé (votre environnement de travail)
- **La tenue** : cohérente avec votre secteur et l'image que vous voulez projeter

## Comment se préparer

La séance ne dure généralement que **20 à 30 minutes**. Voici quelques conseils pour en tirer le meilleur :

1. Choisissez une tenue que vous portez professionnellement — pas de nouveauté le jour J
...
Je réalise des **portraits LinkedIn en Vendée** et dans le Grand Ouest, avec un **studio mobile** installé directement dans vos locaux — pas besoin de vous déplacer. Je travaille aussi en lumière naturelle pour un rendu plus documentaire.

Livraison des fichiers sous 48 à 72 h, optimisés pour LinkedIn (recadrage carré, résolution web) et pour l'impression.

[Voir mes portraits professionnels](/portraits) — [Demander un devis](/demande-de-contact)
